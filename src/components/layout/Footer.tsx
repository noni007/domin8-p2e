        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <a href="/tournaments" className="block text-gray-300 hover:text-blue-400 transition-colors">
                Tournaments
              </a>
              <a href="/leaderboards" className="block text-gray-300 hover:text-blue-400 transition-colors">
                Leaderboards
              </a>
              <a href="/rankings" className="block text-gray-300 hover:text-blue-400 transition-colors">
                Rankings
              </a>
              <a href="/friends" className="block text-gray-300 hover:text-blue-400 transition-colors">
                Community
              </a>
              <a href="/profile" className="block text-gray-300 hover:text-blue-400 transition-colors">
                Profile
              </a>
            </div>
          </div>
